<template>
  ...
  >
    <h2 style="text-align: center">{{ appName }} Privacy Policy</h2>
    <p>
      {{ appName }} instantly connects people everywhere to what’s most
      meaningful to them. Any registered user can send a Fluunk, which is a
      message of 140 characters or less that is public by default and can
      include other content like photos, videos, and links to other websites.
    </p>
    <p></p>
    <p>
      This Privacy Policy describes how and when {{ appName }} collects, uses
      and shares your information when you use our Services.
      {{ appName }} receives your information through our various websites, SMS,
      APIs, email notifications, applications, buttons, and widgets (the
      &quot;<strong>Services</strong>&quot; or &quot;<strong>{{
        appName
      }}</strong
      >&quot;). For example, you send us information when you use
      {{ appName }} from our website, post or receive Fluunks via SMS, or access
      {{ appName }} from an application such as {{ appName }} for Mac,
      {{ appName }} for Android or FluunkDeck. When using any of our Services
      you consent to the collection, transfer, manipulation, storage, disclosure
      ...
      you authorize {{ appName }} to use your information in the United States
      and any other country where {{ appName }} operates.
    </p>
    <p>
      ...
      >&nbsp;or&nbsp;<a href="{{ baseUrl }}/about/contact" target="_blank"
        >here</a
      >.
    </p>
    ...
    <p>
      ...
      create or reconfigure a {{ appName }} account, you provide some personal
    ...
    <p>
      ...
      about our Services or to market to you. You may use your&nbsp;<a
        ...
        target="_blank"
        >account settings</a
      >&nbsp;to unsubscribe from notifications from {{ appName }}. You may also
      ...
      information to help others find your {{ appName }} account, including
      through third-party services and client applications. Your&nbsp;<a
        href="{{ baseUrl }}/account/settings"
        target="_blank"
        >account settings</a
      ...
      help you find {{ appName }} users you know. We may later suggest people to
      follow on {{ appName }} based on your imported address book contacts,
      which you can&nbsp;<a
        href="{{ baseUrl }}/who_to_follow/import"
        target="_blank"
        >delete</a
      >&nbsp;from {{ appName }} at any time. If you email us, we may keep your
      message, email address and contact information to respond to your request.
      If you connect your {{ appName }} account to your account on another
      service in order to cross-post between {{ appName }} and that service, the
      other service may send us your registration or profile information on that
      service and other information that you authorize. This information enables
      cross-posting, helps us improve the Services, and is deleted from
      {{ appName }} within a few weeks of your disconnecting from
      {{ appName }} your account on the other service. Learn more&nbsp;<a
    ...
    <p>
      ...
      {{ appName }}, but we generally give you&nbsp;<a
        href="{{ baseUrl }}/account/settings"
        target="_blank"
        >settings</a
    ...
    <p>
      ...
      location in your Fluunks and in your {{ appName }} profile. You may also
      tell us your location when you set your trend location on
      {{ appName }}.com or enable your computer or mobile device to send us
      location information. You can set your Fluunk location preferences in
      your&nbsp;<a href="{{ baseUrl }}/account/settings" target="_blank"
        >account settings</a
    ...
    <p>
      <strong>Links:</strong>&nbsp;{{ appName }} may keep track of how you
      interact with links across our Services, including our email
      ...
      Services, to provide more relevant advertising, and to be able to share
      aggregate click statistics such as how many times a particular link was
      clicked on.
    </p>
    <p>
      ...
      computer's hard disk. {{ appName }} may use both session cookies and
      persistent cookies to better understand how you interact with our
      Services, to monitor aggregate usage by our users and web traffic routing
      on our Services, and to customize and improve our Services. Most Internet
    ...
    <p>
      ...
      Services, interact with our email notifications, use your
      {{ appName }} account to authenticate to a third-party website or
      application, or visit a third-party website that includes a
      {{ appName }} button or widget. {{ appName }}
    ...
    <p>
      ...
      your visits to third-party websites that integrate {{ appName }} buttons
      or widgets. When these websites first load our buttons or widgets for
      ...
      {{ appName }}. Tailored content is stored with only your browser cookie ID
      and is separated from other Widget Data such as page-visit information.
      This feature is optional and not yet available to all users. If you want,
      you can suspend it or turn it off, which removes from your browser the
      unique cookie that enables the feature. Learn more about the
      feature&nbsp;<a
        href="http://support.fluunker.com/articles/20169421"
        target="_blank"
        >here</a
      >. For Fluunks, Log Data, and other information that we receive from
      interactions with {{ appName }} buttons or widgets, please see the other
      sections of this Privacy Policy.
    </p>
    <p>
      <strong>Third-Party Service Providers:</strong>&nbsp;{{ appName }} uses a
    ...
    <p>
      ...
      web client or application to access your {{ appName }} account.
    </p>
    <p>
    ...
    <p>
      ...
      address fraud, security or technical issues; or to protect {{ appName }}'s
    ...
    <p>
      ...
      {{ appName }} is involved in a bankruptcy, merger, acquisition,
      reorganization or sale of assets, your information may be sold or
      transferred as part of that transaction. The promises in this Privacy
    ...
    <p>
      ...
      and&nbsp;<a href="{{ baseUrl }}/account/settings" target="_blank"
        >account settings</a
      >&nbsp;to access or modify the personal information you provided to us and
      associated with your account.
    </p>
    <p>
      You can also permanently delete your {{ appName }} account. If you follow
      the instructions&nbsp;<a
      ...
      deactivated, it is not viewable on {{ appName }}.com. For up to 30 days
      after deactivation it is still possible to restore your account if it was
    ...
    <p>
      {{ appName }} complies with the U.S.-E.U. and U.S.-Swiss Safe Harbor
      ...
      program, and to view our certification, please visit the&nbsp;<a
    ...
    <p>
      ...
      always be at&nbsp;<a href="{{ baseUrl }}/privacy" target="_blank"
        >{{ baseUrl }}/privacy</a
      >. If we make a change to this policy that, in our sole discretion, is
      material, we will notify you via an @{{ appName }} update or email to the
      email address associated with your account. By continuing to access or use
      the Services after those changes become effective, you agree to be bound
      by the revised Privacy Policy.
    </p>
    <p><em>Effective: May 17, 2012</em></p>
    <p>
      <a href="{{ baseUrl }}/privacy/previous" target="_blank"

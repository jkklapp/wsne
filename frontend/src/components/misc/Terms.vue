<template>
  ...
  >
    ...
    <h3>1. Basic Terms</h3>
    <p>
      You are responsible for your use of the Services, for any Content you post
    ...
    <p>
      ...
      to any requirements or limitations of any networks, devices, services or
      media.
    </p>
    <p>
    ...
    <p>
      ...
      obligation) to remove or refuse to distribute any Content on the Services,
      to suspend or terminate users, and to reclaim usernames without liability
      to you. We also reserve the right to access, read, preserve, and disclose
      any information as we reasonably believe is necessary to (i) satisfy any
    ...
    <p></p>
    <p>
      Except as permitted through the Services, these Terms, or the terms
      provided on
    ...
    <p>
      ...
      to permit us to locate the material; (iv) your contact information,
      including your address, telephone number, and an email address; (v) a
      ...
      owner, its agent, or the law; and (vi) a statement that the information in
    ...
    <p>
      ...
      <a
        ...
        target="_blank"
        >Inactive Account Policy</a
      >.
    </p>
    <p>
      We may suspend or terminate your accounts or cease providing you with all
      or part of the Services at any time for any reason, including, but not
      limited to, if we reasonably believe: (i) you have violated these Terms or
      the
      <a
        href="http://support.fluunker.com/articles/18311-the-fluunker-rules"
        target="_blank"
    ...
    <p>
      ...
      TWITTER ENTITIES DISCLAIM ALL WARRANTIES AND CONDITIONS, WHETHER EXPRESS
    ...
    <p>
      ...
      PAID TWITTER, IF ANY, IN THE PAST SIX MONTHS FOR THE SERVICES GIVING RISE
      TO THE CLAIM.
    </p>
    <p>
      ...
      OR OTHERWISE, AND WHETHER OR NOT THE TWITTER ENTITIES HAVE BEEN INFORMED
    ...
    <p>
      ...
      the State of California without regard to or application of its conflict
      of law provisions or your state or country of residence. All claims, legal
      ...
      County, California, United States, and you consent to the jurisdiction of
    ...
    <p>
      ...
      federal law, the laws of the State of California (excluding choice of
      law).
    </p>
